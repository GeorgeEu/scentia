...
class _GradeCreatingPageState extends State<GradeCreatingPage> {
  ...
  final TextEditingController _studentController = TextEditingController(); // Separate controller
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            StSnackBar(message: 'Failed to grade: $error'));

        // Log the error to the console with additional context if needed
        print('/////////////////////////////////////');
        print("Failed to grade: $error");
        print("Stack trace: $stackTrace"); // Optional: prints the stack trace for debugging
      }
    }
  }
                    ...
                    children: [
                        ...
                        child: DropdownMenu(
                          ...
                          inputDecorationTheme: InputDecorationTheme(
                            ...
                            labelStyle: TextStyle(
                              ...
                              color: Colors.black, // Label text color and style
                            ),
                          ),
                        ),
                      ),
                      Expanded(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            padding: EdgeInsets.only(top: 15, bottom: 15, left: 8, right: 8), // Padding inside the container
                            ...
                            child: Row(
                              mainAxisSize: MainAxisSize.min, // Ensures the container is as small as possible
                              children: [
                                Icon(
